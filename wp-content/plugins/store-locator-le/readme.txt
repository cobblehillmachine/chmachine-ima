...
Try it at our [Demo Site](https://demo.storelocatorplus.com).
Or read about implementation details on our [Docs Site](https://docs.storelocatorlpus.com).

For the latest updates and news follow us on [Twitter](https://twitter.com/locatorplus/).

Or catch updates and How To videos on our YouTube channel.
[youtube https://www.youtube.com/playlist?list=PLP4RKgpdF-0eahOHMUuLqTfg8EjCQ58Wp]

= Details =

[Store Locator Plus](https://wordpress.org/extend/plugins/store-locator-le) has all the features you need to create a location finder on your website.
...
Visit the [SLP Customers page](https://wordpress.storelocatorplus.com/mindset/slp-customers/) to see a sample of some of the people that are using the plugin today.
...
Give us a chance to address your concerns if this plugin doesn't earn 5 stars by [contacting us](https://wordpress.storelocatorplus.com/mindset/contact-us/) directly or by posting in the [support forum](https://www.storelocatorplus.com/forums/) at the website.
...
You can also [contact us](https://wordpress.storelocatorplus.com/mindset/contact-us/) via email.
...
* Extended JavaScript interface for external applications including [MySLP](https://my.storelocatorplus.com/).
* Code simplification for less disk & memory storage.
* Improved code architecture takes advantage of PHP5 and PHP7 caching,especially [opCache](https://wordpress.org/plugins/opcache/) which can significantly improve performance.
...
* [Premier](https://wordpress.storelocatorplus.com/product/premier-subscription/) , [Power](https://wordpress.storelocatorplus.com/product/power/), and [Experience](https://wordpress.storelocatorplus.com/product/experience/) all require version 4.7.6.
...
* Legacy Widgets Add On no longer supported, use [Experience](https://wordpress.storelocatorplus.com/product/experience/)
...
* [Premier Member](https://wordpress.storelocatorplus.com/product/premier-subscription/) styles from our style gallery is now shown alongside standard plugin styles.
...
* Legacy Enhanced Search Add On no longer supported, use [Experience](https://wordpress.storelocatorplus.com/product/experience/).
...
2017 URL and branding updates.  The WordPress plugin site is now at [https://wordpress.storelocatorplus.com/](https://wordpress.storelocatorplus.com/).
...
* Improved schedule jobs processing and messaging for [Power](https://wordpress.storelocatorplus.com/product/power/) and [Premier](https://www.storelocatorplus.com/product/premier-subscription/) add ons.
