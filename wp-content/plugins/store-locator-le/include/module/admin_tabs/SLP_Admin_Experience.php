	...
	class SLP_Admin_Experience extends SLP_Object_With_Objects {
		...
		private function add_results_appearance( ) {
			if (
				...
				$this->slplus->AddOns->get(  'slp-enhanced-results'  , 'active' )
			) {
		...
		function display() {
			...
			if ( ! ( strpos( $this->slplus->SmartOptions->map_home_icon, 'http' ) === 0 ) ) {
				$this->slplus->SmartOptions->map_home_icon = $this->slplus->data['siteURL'] . $this->slplus->SmartOptions->map_home_icon;
			}
			if ( ! ( strpos( $this->slplus->SmartOptions->map_end_icon, 'http' ) === 0 ) ) {
				$this->slplus->SmartOptions->map_end_icon = $this->slplus->data['siteURL'] . $this->slplus->SmartOptions->map_end_icon;
			}
		...
		function save_options() {
			...
			$this->slplus->SmartOptions->set_checkboxes();
